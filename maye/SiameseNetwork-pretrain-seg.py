...
model_name = 'siamese-pretrain-seg'
histories = []
steps = 0
...
def compute_acc(val, prediction, golden, top_k=5):
    ...
    print("\n")
    print("\n")
    print("SEG 60 ACC TOP %d:" % top_k, true_counts / float(total_counts))
    print("\n")
    print("\n")
    print("\n")
    print("\n")
...
if isfile(model_name + '-60.model'):
# if False:
    tmp = keras.models.load_model(model_name + '-60.model')
    ...
    # print("Here")
    vtop, vhigh, pos, prediction = prepare_submission(0.9999, 'mpiotte-pretrain-60.csv')
