...
##Use smallest_side as the image process in tf 
#(https://github.com/tensorflow/models/blob/master/research/slim/preprocessing/vgg_preprocessing.py)
def load_img(path, grayscale=False, color_mode='rgb', smallest_size=256, 
    ...
    #simulate the _smallest_size_at_least function
    if img.size[0]>img.size[1]:
        scale = smallest_size * 1.0 / img.size[1]
    else:
        scale = smallest_size * 1.0 / img.size[0]
    new_0 = int(math.floor(img.size[0]*scale))
    new_1 = int(math.floor(img.size[1]*scale))
    width_height_tuple = (new_0, new_1)
...
class ImageDataGenerator(object):
    ...
    def flow_from_directory(self, directory,
                            target_size=(224, 224), color_mode='rgb', smallest_size=256, ### Add read_size as the size when load imgs
        ...
        return DirectoryIterator(
            directory, self,
            target_size=target_size, color_mode=color_mode, smallest_size=smallest_size,
...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator,
                 target_size=(224, 224), color_mode='rgb', smallest_size=256,  ### Add a smallest_size indicate the smallest size when load imgs
                 classes=None, class_mode='categorical',
                 batch_size=32, shuffle=True, seed=None,
                 data_format=None,
                 save_to_dir=None, save_prefix='', save_format='png',
                 ...
                 interpolation='nearest',
                 num_models=1):
        self.num_models = num_models## The num of models in EE_DPP
        if data_format is None:
            data_format = backend.image_data_format()
    ...
    def _get_batches_of_transformed_samples(self, index_array):
        ...
        for i, j in enumerate(index_array):
            ...
            img = load_img(os.path.join(self.directory, fname),
                           ...
                           smallest_size=self.smallest_size, ## Change to smallest_size
        ...
        batch_y = np.concatenate(y_train, axis=-1)
